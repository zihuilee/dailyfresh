...
EMAIL_PORT = 25 # 发邮件端口
EMAIL_HOST_USER = 'zlzZ1995@yeah.net' # 授权的邮箱
EMAIL_HOST_PASSWORD = 'dailyfresh123' # 邮箱授权时获得的密码，非注册登录密码
EMAIL_FROM = '天天生鲜<zlzZ1995@yeah.net>' # 发件人抬头

CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.24.129:6379/5",
        "OPTIONS": {
...
SERVER_IP = 'http://192.168.24.128:8888/'
